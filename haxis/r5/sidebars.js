...
// add to name space	
	var callbackCount;
	var css, info, stats, settings, readout, headsUp;
	...
	HAX.geneva.secsAfterMid = 0;
	HAX.geneva.speed = 20;
	HAX.geneva.stopId = 7;
	HAX.geneva.timeDisplay = 8;
	...
	HAX.sanFrancisco.secsAfterMid = 17;
	HAX.sanFrancisco.stopId = 1;
	HAX.sanFrancisco.timeDisplay = 12;
	...
	HAX.zurich.secsAfterMid = 9;
	HAX.zurich.speed = 25;
	HAX.zurich.stopId = 5;
	HAX.zurich.timeDisplay = 9;
...
// Settiings UI elements	
	...
	function initCity( c, id ) {
		...
		if ( c !== HAX.cityId  || HAX.data === undefined ) {
			HAX.city = cities[ c ]; 
			HAX.fieldsId = id;
			...
			HAX.secsAfterMid = HAX.city.secsAfterMid; 
			HAX.speed = HAX.city.speed;
			HAX.stopId = HAX.city.stopId;
			HAX.timeDisplay = HAX.city.timeDisplay;
	...
	function initText() {
		...
		stats.style.cssText = 'display: none; left: 350px; width: 400px;' ;
		...
		info.innerHTML =
			'<p><i>2013-04-06<br> ~ Prize Day!</i></p>' +
	...
	function updateSidebar() {
		...
		HAX.xAxis.fields = HAX.xAxis.fieldsTitles = HAX.data[0];

		HAX.yAxis.fields = HAX.yAxis.fieldsTitles = HAX.data[0];

		HAX.zAxis.fields =  HAX.zAxis.fieldsTitles = HAX.data[0];
		...
		HAX.colorsBits.fields =  HAX.colorsBits.fieldsTitles = HAX.data[ 0 ];
...
// console.log('city', id, event, event.srcElement.selectedIndex, event.srcElement.obj)		
